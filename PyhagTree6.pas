...
begin
  ...
  Window.Title := 'Varying Colour Pythagoras Tree';  
  // CenterWindow;
    if first then
    begin
        moveto(x, y);
    ...
    if (n < 15) and (n > 2) then
        SetPenColor(rgb(80 , 95 + 12*n , 13 ))

        
    else if (n <= 1) then
        SetPenColor(rgb(170 + 2*n, 70, 88));
...
begin
    ...
    Pythagorus_Tree(center.x, window.height - 30, 110, -Pi / 2, 10);
    writeln('Render Time = ',Milliseconds/1000,' s');
end.
